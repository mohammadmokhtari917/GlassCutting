...
function bakerystore_header_reset_settings() {
    ...
    remove_theme_mod('header_menucolor');
    remove_theme_mod('header_menuhovercolor');
    remove_theme_mod('header_menuarrowcolor');
    remove_theme_mod('header_submenucolor');
    remove_theme_mod('header_submenuhovercolor');
    remove_theme_mod('header_submenubgcolor');
    remove_theme_mod('header_submenubordercolor');
...
function bakerystore_slider_reset_settings() {
    remove_theme_mod('slider_btn1text');
    remove_theme_mod('slider_btn2text');
    remove_theme_mod('slider_btn2link');
    ...
    remove_theme_mod('slider_slidebarcolor');
    remove_theme_mod('slider_slidebaractivecolor');
    wp_send_json_success(
        array(
            'success' => true,
            'message' => "Reset Completed",
